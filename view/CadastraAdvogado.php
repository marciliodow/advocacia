...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Formulario Advogado</title>
    ...
    <body>
        ...
        <form action="../controler/ValidaAdvogado.php" method="post">
            ...
            <table  bgcolor="#CCC" border="1" align="center">
                ...
                <tr>
                    <td colspan=""><input  type="number" placeholder="00000000000" name="cpf" style="width: 100%"required></td>
                    <td colspan=""><input style="width:310" type="text" placeholder="Nome do cliente" name="nome"required></td>
                    <td colspan=""><input style="width:310" type="text" placeholder="OAB" name="oab"required></td>
